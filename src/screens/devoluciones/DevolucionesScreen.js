  ...
  const applyFilters = (data, query, filter) => {
    ...
    if (query) {
      ...
      filtered = filtered.filter(item => 
        (item.cliente?.nombre?.toLowerCase().includes(lowercaseQuery)) ||
        (item.id?.toLowerCase().includes(lowercaseQuery)) ||
        (item.motivo?.toLowerCase().includes(lowercaseQuery))
      );
    }
        ...
        <Card style={styles.card}>
          <Card.Content>
            <View style={styles.cardHeader}>
              <View>
                <Text style={styles.devolucionId}>{item.id || 'ID no disponible'}</Text>
                <Text style={styles.fecha}>{item.fecha || 'Fecha N/A'} {item.hora || ''}</Text>
              </View>
            ...
            <View style={styles.clienteRow}>
              ...
              <Text style={styles.clienteText}>
                {item.cliente?.nombre || 'Cliente no especificado'}
              </Text>
            </View>
            ...
            <View style={styles.footerRow}>
              ...
              <View style={styles.ventaIdContainer}>
                ...
                <Text style={styles.ventaIdValue}>#{item.venta_id || 'N/A'}</Text>
              </View>
            </View>
          </Card.Content>
        </Card>
